                ...
                <section className="mb-16">
                    ...
                    <div className="glass-card rounded-3xl p-8 md:p-12 max-w-5xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-gradient-to-br from-green-500/10 to-transparent rounded-2xl p-8 border border-green-500/20">
                            ...
                            <div className="bg-gradient-to-br from-accent-orange/10 to-transparent rounded-2xl p-8 border border-accent-orange/20">
                            ...
                            <div className="bg-gradient-to-br from-accent-purple/10 to-transparent rounded-2xl p-8 border border-accent-purple/20">
                            ...
                            <div className="bg-gradient-to-br from-accent-teal/10 to-transparent rounded-2xl p-8 border border-accent-teal/20">
