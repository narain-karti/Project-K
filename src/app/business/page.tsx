    ...
    return (
        <main className="min-h-screen pt-24 px-6 md:px-12 pb-12">
            <LoadingScreen
                ...
                subtitle="Loading Financial Models..."
                    ...
                    <div className="container mx-auto max-w-7xl">
                        ...
                        <section className="mb-16">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="glass-card rounded-2xl p-8 group hover:shadow-[0_0_40px_rgba(249,115,22,0.4)] hover:border-accent-orange/40 hover:bg-gradient-to-br hover:from-accent-orange/10 hover:to-transparent transition-all duration-300">
                        ...
                        <section>
                            ...
                            <div className="glass-card rounded-2xl p-8 mt-8 group hover:shadow-[0_0_40px_rgba(59,130,246,0.4)] hover:border-blue-500/40 hover:bg-gradient-to-br hover:from-blue-500/10 hover:to-transparent transition-all duration-300">
